...
const labels = [
  ...
  { name: '🎨 Html&css', color: 'FEF2C0', description: '마크업 & 스타일링' },
  {
    name: '🐞 BugFix',
    color: 'd73a4a',
    description: "Something isn't working",
  },
  { name: '💻 CrossBrowsing', color: 'C5DEF5', description: '브라우저 호환성' },
  {
    name: '📃 Docs',
    color: '1D76DB',
  ...
  { name: '🥰 Accessibility', color: 'facfcf', description: '웹접근성 관련' },
  {
    name: '✅ Test',
    color: 'ccffc4',
...
labels.forEach((label) => {
  try {
    ...
    console.log(
      `⚠️  '${label.name}' 라벨은 이미 존재하거나 생성 중 오류가 발생했습니다.`
    );
  }
});
